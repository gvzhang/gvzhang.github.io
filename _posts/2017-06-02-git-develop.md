...
![Linus](https://static.zgjian.cc/markdown/LinuxCon_Europe_Linus_Torvalds_03.jpg)
林纳斯（Linus）·本纳第克特·托瓦兹
...
### 版本控制系统
##### 本地版本控制系统
![本地版本控制系统](https://static.zgjian.cc/markdown/local-version-control.png)

##### 集中化版本控制系统
![集中化版本控制系统](https://static.zgjian.cc/markdown/svn-version-control.png)
（权限、联网、灾难）

##### 分布式版本控制系统
![分布式版本控制系统](https://static.zgjian.cc/markdown/git-version-control.png)
...
![分支管理](https://static.zgjian.cc/markdown/git-model@2x.png)
...
### Github Flow
![Github Flow](https://static.zgjian.cc/markdown/bg2015122305.jpg)
#### 优缺点
